...
import { Building2, Clock3, Heart, Loader2, Mail, MapPin, Newspaper, Phone, UserRound } from 'lucide-react';
...
export function PublicOrganizationPage(){
  ...
  useEffect(()=>{
    ...
    const load=async()=>{
      ...
      setNews((newsResult.data||[]) as News[]);setStaff((staffResult.data||[]) as Staff[]);setLoading(false);
    };
