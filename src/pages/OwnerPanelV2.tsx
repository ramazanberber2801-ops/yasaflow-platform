    ...
    <div className="p-4 space-y-5" style={{ color: brand.text }}>
      <div className="rounded-3xl p-5 border-2 shadow-sm" style={{ backgroundColor: brand.secondary, color: brand.secondaryText, borderColor: mix(brand.primary, 24) }}>
        <div className="flex items-center justify-between gap-4">
          ...
          <button type="button" onClick={startNewOrganization} className="px-3 py-2 rounded-xl text-xs font-medium flex items-center gap-1.5" style={{ backgroundColor: mix(brand.primary, 25), color: brand.secondaryText }}><Plus size={14} /> Ny</button>
        </div>
      </div>
      ...
      {isCreating && <button type="button" onClick={cancelCreate} className="w-full py-3 rounded-xl text-sm font-medium flex items-center justify-center gap-2 bg-white border" style={{ borderColor: mix(brand.primary, 25), color: brand.text }}><X size={16} /> Avbryt opprettelse</button>}
