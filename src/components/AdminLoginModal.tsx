      ...
      <div className="fixed inset-0 z-[100] bg-black/60 flex items-center justify-center p-4">
        <div className="bg-[#FAF6F0] w-full max-w-sm rounded-2xl p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <input className="w-full p-3 border rounded-xl" placeholder="E-posta" onChange={e => setUsername(e.target.value)} required />
          ...
          <button onClick={() => setShowForgot(true)} className="w-full text-xs text-[#C5A880] hover:underline mt-4">Şifremi Unuttum?</button>
        </div>
      </div>
